                                                            ...
                                                            children: [
                                                              Column(
                                                                ...
                                                                children: [
                                                                  ...
                                                                  Padding(
                                                                    padding: const EdgeInsets.all(8.0),
                                                                    child: Text('Orange(1*500g),Donut(7 pieces-250g each),brinjal(2*900g),potato(3*500g),''\n' +'sandwich(3*500g),oil(3*500g),bananas(3*500g)and more.',style:TextStyle(fontSize:14,color:Colors.black45,fontWeight:FontWeight.w400),),
                                                                  ),
                                                                ],
                                                              ),
